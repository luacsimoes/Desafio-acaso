...
const Signup = () => {
  ...
  useLayoutEffect(() => {
    setPasswordMatchs(password === confirmPassword);
      ...
      <ScrollView keyboardDismissMode="on-drag">
        ...
        <Content>
          ...
          <Input
            ...
            rightIcon={false}
          />
          {!passwordMatchs && <ErrorText>Senhas não coincidem</ErrorText>}
          <LabelPassword passwordMatch={passwordMatchs}>
            Confirme sua senha*
          </LabelPassword>
          <Input
